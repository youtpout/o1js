...
const JSOO_DUMP = `${DUMP_DIR}/w1-gates-jsoo.json`;
const BRANCHES_DUMP = `${DUMP_DIR}/w1-branches.json`;
...
if (mode === 'jsoo') {
  ...
  writeFileSync(`${DUMP_DIR}/w1-gates-rust.json`, JSON.stringify(rustProgram));
